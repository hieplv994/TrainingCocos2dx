 var popupWinLayer = cc.Layer.extend({
    ...
    init: function(){
        ...
        var btnBackToMenu = commonInstance.createButton(res.btnBackMenu_png, 0.415, 0.25);
        ...
        var btnNextLevel = commonInstance.createButton(res.btnNextLevel_png, 0.61, 0.25);
    ...
    //Event Button Back To Menu level
