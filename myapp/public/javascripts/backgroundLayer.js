...
var HoleSprite = cc.Sprite.extend({
    ...
    mouseAction: function(){
        ...
        this.spriteMouse.runAction(cc.sequence(
            ...
            cc.callFunc(function(){
                    ...
                    clientInstance.mouseDown();
                    clientInstance.missCombo();
                }, this), 
        ));
        // hit mouse animate
    ...
    hitMouse: function(){
        //send type from client to server
        clientInstance.sendType("Mouse");
    },
    ...
    hitDiamond: function(){
        //send type from client to server
        clientInstance.sendType("Diamond");
